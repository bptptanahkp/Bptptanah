      ...
      <li class="nav-item">
        ...
        <div id="peraturan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/peraturanpelanggan">Prosedur Pesan Uji Tanah</a>
      ...
      <li class="nav-item">
        ...
        <div id="hasilpesan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/datapesan">Pesanan Pelanggan</a>
            <a class="collapse-item" href="/datapermintaan">Detail Pesanan Pelanggan</a>
          </div>
        </div>
      </li>
