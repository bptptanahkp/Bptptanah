...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">Edit Pupuk Organik, Kompos, Cair </h5>
            <a class="text-danger" target="_blank">*)per sampel</a>
        </div>
        <div class="card-body">
        {!! Form::model($ed,['method'=>'PATCH', 'action'=> ['PupukOrganik_Kompos_CairController@update',$ed->id],'files'=>true]) !!}

         <div class="form-group">
            {!! Form::label('id', 'Nomor :') !!}
            {{ Form::text('id', null,['class'=>'form-control','placeholder'=>'Jenis Uji' ,'required'])}}
        </div>
        <div class="form-group">
